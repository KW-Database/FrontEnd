...
const Time_button = styled.button`
  ...
  width:90px; height:35px; margin-right:60px; 
...
const dummyData= {
  ...
  Data: [
    ...
    //{ x: Datetime (2022-02-02, 15:15:50), y: [시가, 고가, 저가, 종가] },
    {
...
const Exchange_graph = () => {
  ...
  return(
    <div>
      ...
      <Graph>
        <ReactApexChart options={options} series={series} type="candlestick" height={300} width={700}/>
      </Graph>
    </div>
  );
}
