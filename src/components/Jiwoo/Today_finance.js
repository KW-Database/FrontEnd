...
const dummyData= [{
        ...
        return {
          ...
          Data: props.Data?.map((props) => {
            return [
              ...
              [props.start, props.highest, props.lowest, props.end_price],
            ];
          })
        }
      })
    */
    ...
    //{ x: Datetime (2022-02-02, 15:15:50), y: [시가, 고가, 저가, 종가] },
    {
      ...
      //new Date(Date.parse(new Date('2018-10-06 07:30:00'))),
      x: new Date(Date.parse(new Date('2018-10-06 07:30:00'))),
    ...
    {
      x: new Date(1538818200000),
      y: [6619.54, 6635.17, 6614.15, 6630]
    },
    {
      x: new Date(1538820000000),
      y: [6620.33, 6634.15, 6617.24, 6624.61]
    ...
    {
      x: new Date(1538802000000),
      y: [6612, 6634.12, 6608.43, 6632.95]
    },
    {
      x: new Date(1538803800000),
      y: [6623.91, 6623.91, 6615, 6615.67]
